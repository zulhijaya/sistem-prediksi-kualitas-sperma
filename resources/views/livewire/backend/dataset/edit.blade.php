        ...
        <div class="mb-8">
            ...
            <div class="
                ...
                <label for="{{ $criteria->name . $criteria->id }}" class="group flex items-center space-x-1 cursor-pointer">
                    <input wire:model.defer="criteria_ids.{{ $index }}" id="{{ $criteria->name . $criteria->id }}" type="radio" name="{{ $attribute->name }}" value="{{ $criteria->id }}" class="w-3.5 h-3.5 accent-pink-500 cursor-pointer">
        ...
        <div class="mb-8">
            ...
            <div class="flex items-center space-x-6">
                <label for="normal" class="group flex items-center space-x-1 cursor-pointer">
                    <input wire:model.defer="dataset.output" id="normal" type="radio" name="output" value="normal" class="w-3.5 h-3.5 accent-pink-500 cursor-pointer">
                ...
                <label for="altered" class="group flex items-center space-x-1 cursor-pointer">
                    <input wire:model.defer="dataset.output" id="altered" type="radio" name="output" value="altered" class="w-3.5 h-3.5 accent-pink-500 cursor-pointer">
        ...
        <div>
            ...
            <div class="flex items-center space-x-6">
                <label for="training" class="group flex items-center space-x-1 cursor-pointer">
                    <input wire:model.defer="dataset.data_type" id="training" type="radio" name="data_type" value="training" class="w-3.5 h-3.5 accent-pink-500 cursor-pointer">
                    <span class="truncate">Training</span>
                </label>
                <label for="testing" class="group flex items-center space-x-1 cursor-pointer">
                    <input wire:model.defer="dataset.data_type" id="testing" type="radio" name="data_type" value="testing" class="w-3.5 h-3.5 accent-pink-500 cursor-pointer">
